...
public class CodeUnit {
    ...
    public static void main(String[] args) throws Exception {
        CodeUnit.encode("https://image-code-1316722170.cos.ap-chengdu.myqcloud.com/yingying2.png","","c:\\image-temp\\photo.jpg",false,600,0);
    }




        private static final Logger LOGGER = LoggerFactory.getLogger(CodeUnit.class);
...
//            System.out.println("文件已保存至"+file.getAbsoluteFile());
